<html>
	<head>
		<title> US Clinical Trials Drug Hierarchy</title>
	...
	<body>
		...
		<div class="container">
			<h4 class="title">Manage Drugs Hierachy</h4>
			<div class="row">
			...
			<div class="row">
				<div class="col-6 col-md-5 col-lg-4 box">
					...
					<div class="row padding-5">
						...
						<button class="offset-1 btn btn-danger" onclick="deleteNode()" title="Delete Selected Drugs"><i class="fa fa-trash" aria-hidden="true"></i></button>
					</div>
